package exception.seminars.seminar02.task01;
...
public class Main {
    ...
    {
        String patch = "R:\\JavaOOP\\src\\exception\\seminars\\seminar02\\task01\\names.txt";
    ...
    public static void modificationArray(List<String[]> list) {
        for (String[] item: list) {
            if (item.length != 2) {
                throw new IllegalArgumentException("Количество элементов не два");
            }
